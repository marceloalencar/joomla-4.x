...
<?php if (!empty($this->intro_items)) : ?>
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		<?php
			...
			if ($rowcount==1) : ?>
			<div class="tile-list-1">
			<div class="items-row cols-<?php echo (int) $this->params->get('num_columns');?> <?php echo 'row-'.$row ; ?> row-fluid">
			<?php endif; ?>

			<div class="tileItem item column-<?php echo $rowcount;?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?> span<?php echo 12/((int) $this->params->get('num_columns'));?>">
				<?php
					$this->item = &$item;
