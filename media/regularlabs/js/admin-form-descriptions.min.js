...
const controls=control_group.querySelector('.controls');this.create(label,controls,description);});},createFromClasses:function(){document.querySelectorAll('div.rl-popover:not(.rl-moved)').forEach((description)=>{const label=description.previousElementSibling;if(!label){return;}
